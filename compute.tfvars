...
vms = {
  ...
  tfansible = {
    ...
    extra_disk_gb = 0
    networks      = [{ name = "prod-production-infra-app-10.11.90.0-24", ip = "10.11.90.14", enabled = true }]
    tags          = { Owner = "infra-team", Env = "prod", App = "ansible" }
  }

  # Proxy Squid (Double patte : DMZ + APP)
# Proxy Squid (Triple patte : DMZ exposed + DMZ admin + DMZ transit)
proxy = {
